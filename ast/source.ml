...
module Metadata = struct
  ...
  let create_for_testing
      ...
      ()
    =
    { autogenerated; local_mode; ignore_codes; ignore_lines; number_of_lines; version; raw_hash }
  ...
  let parse ~qualifier lines =
    ...
    in
    let collect index (version, local_mode, ignore_codes, ignore_lines, autogenerated) line =
      let local_mode =
    ...
    in
    let version, local_mode, ignore_codes, ignore_lines, autogenerated =
...
let mode ~configuration ~local_mode : mode =
  ...
  | PlaceholderStub, _ ->
      Declare
  | Default, { Configuration.Analysis.strict = true; _ } -> Strict
  | Default, { Configuration.Analysis.declare = true; _ } -> Declare
  | Default, _ -> Unsafe
