...
module Metadata = struct
  ...
  let parse ~qualifier lines =
    ...
    in
    let collect index (version, debug, local_mode, ignore_codes, ignore_lines, autogenerated) line =
      let local_mode =
    ...
    in
    let version, debug, local_mode, ignore_codes, ignore_lines, autogenerated =
