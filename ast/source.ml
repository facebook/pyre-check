...
module Metadata = struct
  ...
  let parse ~qualifier:_ lines =
    ...
    let collect
        index
        (local_mode, unused_local_modes, ignore_codes, ignore_lines, autogenerated)
        line
      =
      ...
      let ignore_codes =
        if is_default_with_suppress line then
          ...
          ignore_codes
      in
      local_mode, unused_local_modes, ignore_codes, ignores, autogenerated || is_autogenerated
    in
    let local_mode, unused_local_modes, ignore_codes, ignore_lines, autogenerated =
      List.map ~f:(fun line -> String.rstrip line |> String.lowercase) lines
      |> List.foldi ~init:(None, [], [], Int.Map.empty, false) ~f:collect
    in
    {
      autogenerated;
      local_mode;
