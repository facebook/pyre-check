...
(* The general protocol for a next function is to return either Wait (indicating that workers
   should wait until more elements are added to the workload), or Job of a bucket, or Done to
...
(* Makes a bucket out of a list, without regard for number of workers or the size of the list. *)
