...
let read_process_output name args =
  with_pipe
  @@ fun in_pipe -> with_pipe @@ fun out_pipe -> read_process name args in_pipe out_pipe out_pipe
...
let read_process_stdout name args =
  ...
  @@ fun in_pipe ->
  with_pipe
  @@ fun out_pipe -> with_pipe @@ fun err_pipe -> read_process name args in_pipe out_pipe err_pipe
