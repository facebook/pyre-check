...
(* To add a new analysis, the analysis should invoke the Make functor below. The functor adds a new
   constant constructor to 'analysis kind.

   This Kind constructor can then be used by analyses to lookup their own results/fixpoint
   information (or from another analysis).
...
val make_model : ('result, 'model) analysis_data Kind.kind -> 'model -> model_t

val with_model : ('result, 'model) analysis_data Kind.kind -> 'model -> model_t -> model_t
