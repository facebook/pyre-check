...
class ConfigurationTest(unittest.TestCase):
    ...
    def test_init(self, os_environ, json_load, builtins_open) -> None:
        ...
        # Test multiple definitions of the autogenerated files.
        json_load.side_effect = [
            {
                "autogenerated": ["buck-out/dev/gen"]
            },
    ...
    def test_empty_configuration(self, os_path_isdir) -> None:
        ...
        with patch.object(Configuration, '_read'):
            ...
            while True:
                bundled_typeshed_calls.append(call(os.path.join(
                    directory, "pyre_check/typeshed/stdlib/")))
                environment_typeshed_calls.append(call(os.path.join(
                    directory, "typeshed/stdlib/")))
