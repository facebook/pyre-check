                ...
                let scope, value =
                  ...
                  | Name (Name.Identifier name) ->
                      ...
                      let scope =
                        ...
                        then
                          let alias =
                            qualify_local_identifier name ~qualifier |> Reference.create
                          in
                          {
                            scope with
                            aliases =
            ...
            let scope, items =
              let qualify_item (scope, reversed_items) (name, alias) =
                let scope, item =
                  ...
                  in
                  ( renamed_scope,
                    (qualify_expression ~qualify_strings:DoNotQualify ~scope name, alias) )
                in
...
let qualify = Qualify.qualify_source
