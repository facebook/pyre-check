...
let test_add_constraint context =
  ...
  assert_add
    ...
    ~expected_solutions:[[]]
    ();
  assert_add ~left:"C" ~right:"T_Unconstrained" ~expected_solutions:[["T_Unconstrained", "C"]] ();
  assert_add ~left:"D" ~right:"T_Unconstrained" ~expected_solutions:[["T_Unconstrained", "D"]] ();
  assert_add ~left:"Q" ~right:"T_Unconstrained" ~expected_solutions:[["T_Unconstrained", "Q"]] ();
  assert_add ~left:"C" ~right:"T_Bound_C" ~expected_solutions:[["T_Bound_C", "C"]] ();
  assert_add ~left:"D" ~right:"T_Bound_C" ~expected_solutions:[["T_Bound_C", "D"]] ();
  assert_add ~left:"Q" ~right:"T_Bound_C" ~expected_solutions:[] ();
  assert_add ~left:"C" ~right:"T_Bound_D" ~expected_solutions:[] ();
  assert_add ~left:"C" ~right:"T_C_Q" ~expected_solutions:[["T_C_Q", "C"]] ();
  ...
  assert_add
    ...
    ~expected_solutions:[["T_Bound_C", "typing.Any"]]
    ();
  assert_add ~left:"typing.Any" ~right:"T_C_Q" ~expected_solutions:[["T_C_Q", "typing.Any"]] ();
  ...
  assert_add ~left:"D" ~right:"T_C_Q" ~expected_solutions:[["T_C_Q", "C"]] ();
  assert_add ~left:"C" ~right:"T_D_Q" ~expected_solutions:[] ();
  assert_add
  ...
  assert_add
    ...
    ();
  assert_add ~left:"T_Bound_Union" ~right:"typing.Union[int, str]" ~expected_solutions:[[]] ();
  ...
  assert_add
    ...
    ();
  assert_add ~left:"T_Bound_C" ~right:"T_Bound_D" ~expected_solutions:[] ();
  assert_add
    ~left:"T_Bound_Union"
    ~right:"T_Bound_Union"
  ...
  (* Bound => Explicit *)
  assert_add ~left:"T_Bound_D" ~right:"T_C_Q" ~expected_solutions:[["T_C_Q", "C"]] ();
  assert_add ~left:"T_Bound_C" ~right:"T_D_Q" ~expected_solutions:[] ();
  ...
  assert_add
    ...
    ();
  assert_add ~left:"T_D_Q" ~right:"T_Bound_D" ~expected_solutions:[] ();

  (* Explicit => Explicit *)
  assert_add ~left:"T_C_Q" ~right:"T_C_Q_int" ~expected_solutions:[["T_C_Q_int", "T_C_Q"]] ();
  ...
  assert_add ~left:"T_D_Q" ~right:"T_C_Q_int" ~expected_solutions:[] ();
  assert_add
    ~leave_unbound_in_left:["T_Unconstrained"]
  ...
  assert_add
    ...
    ();
  assert_add ~left:"int" ~right:"typing.Union[T1, T2, int]" ~expected_solutions:[[]] ();
  assert_add
  ...
  assert_add
    ...
    ~expected_solutions:[[]]
    ();
  assert_add ~left:"typing.Type[test.ChildA]" ~right:"test.Meta" ~expected_solutions:[] ();
  assert_add ~left:"typing.Type[test.HasMeta]" ~right:"test.Meta" ~expected_solutions:[[]] ();
  ...
  (* Literals. *)
  assert_add ~left:{| typing_extensions.Literal["hello"] |} ~right:"str" ~expected_solutions:[[]] ();
  assert_add
  ...
  assert_add
    ...
    ~expected_solutions:[[]]
    ();
  assert_add ~left:{| typing_extensions.Literal[str] |} ~right:"str" ~expected_solutions:[[]] ();
  assert_add ~left:"str" ~right:{| typing_extensions.Literal["hello"] |} ~expected_solutions:[] ();
  assert_add ~left:"str" ~right:{| typing_extensions.Literal[str] |} ~expected_solutions:[] ();

  (* Top type. *)
  assert_add_direct ~left:Type.Top ~right:Type.none ~expected_solutions:[] ();
  ()
...
let test_add_constraint_recursive_type context =
  ...
  in
  assert_add_direct ~left:tree_annotation ~right:tree_annotation ~expected_solutions:[[]] ();
  assert_add_direct ~left:Type.integer ~right:tree_annotation ~expected_solutions:[[]] ();
  assert_add_direct ~left:Type.string ~right:tree_annotation ~expected_solutions:[] ();
  assert_add_direct ~left:Type.Top ~right:tree_annotation ~expected_solutions:[] ();
  assert_add_direct
  ...
  assert_add_direct ~left:tree_annotation ~right:Type.integer ~expected_solutions:[] ();
  assert_add_direct
  ...
  in
  assert_add_direct ~left:json_annotation ~right:json_annotation ~expected_solutions:[[]] ();
  assert_add_direct ~left:Type.integer ~right:json_annotation ~expected_solutions:[[]] ();
  assert_add_direct ~left:Type.string ~right:json_annotation ~expected_solutions:[] ();
  assert_add_direct
...
let test_add_constraint_type_variable_tuple context =
  ...
  assert_add ~left:"Tensor[int, int]" ~right:"Tensor[float, int]" ~expected_solutions:[] ();
  ...
  assert_add
    ...
    ~expected_solutions:[[]]
    ();
  assert_add ~left:"typing.Tuple[str, ...]" ~right:"typing.Tuple[int]" ~expected_solutions:[] ();
...
let test_add_constraint_readonly context =
  let assert_add, assert_add_direct, _, _ = make_assert_functions context in
  assert_add ~left:"pyre_extensions.ReadOnly[C]" ~right:"C" ~expected_solutions:[] ();
  assert_add ~left:"D" ~right:"pyre_extensions.ReadOnly[C]" ~expected_solutions:[[]] ();
  assert_add
  ...
  assert_add
    ...
    ~expected_solutions:[["T_Unconstrained", "pyre_extensions.ReadOnly[C]"]]
    ();
  assert_add ~left:"pyre_extensions.ReadOnly[C]" ~right:"T_Bound_object" ~expected_solutions:[] ();
  assert_add ~left:"pyre_extensions.ReadOnly[C]" ~right:"typing.Any" ~expected_solutions:[[]] ();
  assert_add
    ~left:"typing.Any"
    ~right:"pyre_extensions.ReadOnly[T]"
    ~expected_solutions:[["T", "typing.Any"]]
    ();
  assert_add ~left:"pyre_extensions.ReadOnly[C]" ~right:"object" ~expected_solutions:[] ();
  assert_add
    ~left:"typing.Union[pyre_extensions.ReadOnly[C], str]"
    ~right:"object"
    ~expected_solutions:[]
    ();
  assert_add ~left:"object" ~right:"pyre_extensions.ReadOnly[object]" ~expected_solutions:[[]] ();
  assert_add_direct
    ~left:Type.Bottom
  ...
  assert_add_direct
    ...
    ~expected_solutions:[[]]
    ();
  assert_add ~left:"None" ~right:"pyre_extensions.ReadOnly[object]" ~expected_solutions:[[]] ();
  assert_add ~left:"None" ~right:"pyre_extensions.ReadOnly[C]" ~expected_solutions:[] ();
  assert_add
