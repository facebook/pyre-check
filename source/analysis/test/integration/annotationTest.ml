...
let test_check_typevar_arithmetic =
  test_list
    [
      labeled_test_case __FUNCTION__ __LINE__
      @@ assert_type_errors
      ...
      @@ assert_type_errors
           {|
            ...
            |}
           [
             "Revealed type [-1]: Revealed type for `test.f(1, 2)` is \
      ...
      @@ assert_type_errors
           {|
            ...
            |}
           [
             "Revealed type [-1]: Revealed type for `test.push(v)` is \
              `Vec[typing_extensions.Literal[11]]`.";
             "Revealed type [-1]: Revealed type for `test.pop(v)` is \
              `Vec[typing_extensions.Literal[9]]`.";
           ];
      labeled_test_case __FUNCTION__ __LINE__
      @@ assert_type_errors
           {|
      ...
      @@ assert_type_errors
           {|
            ...
            |}
           [
             "Invalid type parameters [24]: Type parameter `typing_extensions.Literal['foo']` \
              violates constraints on `Variable[pyre_extensions._B (bound to int)]` in generic \
              type `Add`.";
             "Invalid type parameters [24]: Type parameter `typing_extensions.Literal['foo']` \
              violates constraints on `Variable[pyre_extensions._B (bound to int)]` in generic \
              type `Multiply`.";
      ...
      @@ assert_type_errors
           {|
              ...
              pop(v,3)
            |}
           (* Currently this is a limitation of our system. We can only resolve subtyping
              relationships on IntExpressions of the form: factor * N + constant <: factor' * M +
              constant'. That is because to set bounds we need to isolate one type variable in one
              side of the expression what requires the use of some algebra that is not allowed due
              to the lack of inverse operators (subtraction and division)

              Eventually, we would like this to work at least for polynomials of degree 1. See
              T70449275 *)
           [
             "Incompatible parameter type [6]: In call `pop`, for 1st positional argument, \
              expected `Vec[pyre_extensions.IntExpression[M + N]]` but got `Vec[int]`.";
           ];
      labeled_test_case __FUNCTION__ __LINE__
      @@ assert_default_type_errors
           {|
...
let test_check_literal_arithmetic =
  test_list
    [
      labeled_test_case __FUNCTION__ __LINE__
      @@ assert_default_type_errors
           ...
           [
             ...
             "Revealed type [-1]: Revealed type for `test6` is `pyre_extensions.IntExpression[1 + \
              N]`.";
             "Revealed type [-1]: Revealed type for `test7` is `pyre_extensions.IntExpression[3 + \
              N]`.";
           ];
      labeled_test_case __FUNCTION__ __LINE__
      @@ assert_default_type_errors
           ...
           [
             ...
             "Revealed type [-1]: Revealed type for `test6` is `pyre_extensions.IntExpression[1 + \
              -N]`.";
             "Revealed type [-1]: Revealed type for `test7` is `pyre_extensions.IntExpression[-1 + \
              -N]`.";
           ];
      labeled_test_case __FUNCTION__ __LINE__
      @@ assert_default_type_errors
           ...
           [
             ...
             "Revealed type [-1]: Revealed type for `test7` is `pyre_extensions.IntExpression[4 + \
              2N]`.";
           ];
      labeled_test_case __FUNCTION__ __LINE__
      @@ assert_default_type_errors
           ...
           [
             ...
             "Revealed type [-1]: Revealed type for `test7` is \
              `pyre_extensions.IntExpression[(1//N)]`.";
             "Revealed type [-1]: Revealed type for `test8` is \
              `pyre_extensions.IntExpression[(1//(2 + N))]`.";
           ];
      labeled_test_case __FUNCTION__ __LINE__
      @@ assert_default_type_errors
           {|
            ...
            |}
           [
             "Revealed type [-1]: Revealed type for `test1` is `pyre_extensions.IntExpression[1 + \
              N]`.";
             "Unsupported operand [58]: `+` is not supported for operand types `Variable[N (bound \
              to int)]` and `str`.";
             "Revealed type [-1]: Revealed type for `test3` is `typing.Any`.";
             "Revealed type [-1]: Revealed type for `test4` is `int`.";
             "Revealed type [-1]: Revealed type for `test5` is `pyre_extensions.IntExpression[M + \
              N]`.";
      ...
      @@ assert_default_type_errors
           {|
            ...
            |}
           [
             "Revealed type [-1]: Revealed type for `test1` is \
              `pyre_extensions.IntExpression[(N//2)]`.";
             "Unsupported operand [58]: `//` is not supported for operand types `Variable[N (bound \
              to int)]` and `str`.";
             "Revealed type [-1]: Revealed type for `test3` is `typing.Any`.";
             "Revealed type [-1]: Revealed type for `test4` is `int`.";
             "Revealed type [-1]: Revealed type for `test5` is \
              `pyre_extensions.IntExpression[(N//M)]`.";
             "Revealed type [-1]: Revealed type for `test6` is \
              `pyre_extensions.IntExpression[(N//(2 + N))]`.";
           ];
    ]


let test_check_int_expression_arithmetic =
  test_list
    [
      labeled_test_case __FUNCTION__ __LINE__
      @@ assert_default_type_errors
           {|
            ...
            |}
           [
             "Revealed type [-1]: Revealed type for `test1` is `pyre_extensions.IntExpression[3 + \
              N]`.";
             ...
             "Revealed type [-1]: Revealed type for `test5` is `pyre_extensions.IntExpression[2 + \
              2N]`.";
             "Revealed type [-1]: Revealed type for `test6` is `pyre_extensions.IntExpression[4 + \
              2N]`.";
           ];
      labeled_test_case __FUNCTION__ __LINE__
      @@ assert_default_type_errors
      ...
      @@ assert_default_type_errors
           {|
            ...
            |}
           [
             "Revealed type [-1]: Revealed type for `test1` is `pyre_extensions.IntExpression[4 + \
              2N]`.";
             "Unsupported operand [58]: `*` is not supported for operand types \
              `pyre_extensions.IntExpression[2 + N]` and `str`.";
             "Revealed type [-1]: Revealed type for `test3` is `typing.Any`.";
             "Revealed type [-1]: Revealed type for `test4` is `int`.";
             "Revealed type [-1]: Revealed type for `test5` is `pyre_extensions.IntExpression[2N + \
              N^2]`.";
             "Revealed type [-1]: Revealed type for `test6` is `pyre_extensions.IntExpression[4 + \
              4N + N^2]`.";
           ];
...
let test_check_typevar_division_simplify =
  test_list
    [
      labeled_test_case __FUNCTION__ __LINE__
      @@ assert_type_errors
           ...
           [
             ...
             "Revealed type [-1]: Revealed type for `test.f` is `typing.Callable(f)[[Named(a, \
              Variable[A (bound to int)])], pyre_extensions.IntExpression[2A]]`.";
           ];
      labeled_test_case __FUNCTION__ __LINE__
      @@ assert_type_errors
           {|
           ...
           [
             ...
             "Revealed type [-1]: Revealed type for `test.f` is `typing.Callable(f)[[Named(a, \
              Variable[A (bound to int)])], pyre_extensions.IntExpression[2(A//2)]]`.";
           ];
      labeled_test_case __FUNCTION__ __LINE__
      @@ assert_type_errors
           {|
           ...
           [
             ...
             "Revealed type [-1]: Revealed type for `test.f` is `typing.Callable(f)[[Named(a, \
              Variable[A (bound to int)]), Named(b, Variable[B (bound to int)])], \
              pyre_extensions.IntExpression[((4A + 3B)//(2A + 5B))]]`.";
           ];
      labeled_test_case __FUNCTION__ __LINE__
      @@ assert_type_errors
           {|
           ...
           [
             ...
             "Revealed type [-1]: Revealed type for `test.f` is `typing.Callable(f)[[Named(a, \
              Variable[A (bound to int)]), Named(b, Variable[B (bound to int)])], \
              pyre_extensions.IntExpression[B + ((A + B)//A)]]`.";
           ];
    ]
    ...
    [
      ...
      @@ assert_default_type_errors
           ...
           [
             "Broadcast error [2001]: Broadcast error at expression `test.foo((3, 3))`; types \
              ...
              `Tuple[typing_extensions.Literal[3], typing_extensions.Literal[3]]` cannot be \
      ...
      @@ assert_default_type_errors
           ...
           [
             ...
             "Revealed type [-1]: Revealed type for `t4` is `NewTensor[int, \
      ...
      @@ assert_default_type_errors
           {|
            ...
            |}
           [
             "Broadcast error [2001]: Broadcast error at expression `test.foo((2, 2), (3, 3), (4, \
              4))`; types `Tuple[typing_extensions.Literal[2], typing_extensions.Literal[2]]` and \
              `Tuple[typing_extensions.Literal[3], typing_extensions.Literal[3]]` cannot be \
              broadcasted together.";
             "Broadcast error [2001]: Broadcast error at expression `test.foo((2, 2), (3, 3), (4, \
              4))`; types `Tuple[typing_extensions.Literal[3], typing_extensions.Literal[3]]` and \
              `Tuple[typing_extensions.Literal[4], typing_extensions.Literal[4]]` cannot be \
              broadcasted together.";
      ...
      @@ assert_default_type_errors
           {|
            ...
            |}
           [
             "Incompatible overload [43]: The implementation of `Foo.foo` does not accept all \
              possible arguments of overload defined on line `14`.";
             "Incompatible overload [43]: The implementation of `Foo.foo` does not accept all \
              possible arguments of overload defined on line `16`.";
             "Revealed type [-1]: Revealed type for `x.bar()` is `Foo[int, \
              typing_extensions.Literal[3], typing_extensions.Literal[2], \
              typing_extensions.Literal[2], str]`.";
      ...
      @@ assert_default_type_errors
           ...
           [
             "Revealed type [-1]: Revealed type for `y1` is `Tuple[typing_extensions.Literal[4], \
              typing_extensions.Literal[3]]`.";
             "Broadcast error [2001]: Broadcast error at expression `test.foo((1, 3), (4, 99))`; \
              types `Tuple[typing_extensions.Literal[1], typing_extensions.Literal[3]]` and \
              `Tuple[typing_extensions.Literal[4], typing_extensions.Literal[99]]` cannot be \
              broadcasted together.";
    ...
    [
      ...
      @@ assert_default_type_errors
           ...
           [
             ...
             "Revealed type [-1]: Revealed type for `test.f` is `typing.Callable(f)[[Named(a, \
              Variable[A (bound to int)])], pyre_extensions.IntExpression[((-2A + A^2)//-4) + \
              (A//2)]]`.";
           ];
    ]


let test_check_product =
  test_list
    [
      labeled_test_case __FUNCTION__ __LINE__
      @@ assert_default_type_errors
      ...
      @@ assert_default_type_errors
           ...
           [
             ...
             "Incompatible parameter type [6]: In call `cube`, for 1st positional argument, \
              expected `Variable[N (bound to int)]` but got `str`.";
           ];
      labeled_test_case __FUNCTION__ __LINE__
      @@ assert_default_type_errors
           {|
...
let () =
  ...
  >::: [
         ...
         test_check_typevar_arithmetic;
         test_check_literal_arithmetic;
         test_check_int_expression_arithmetic;
         test_check_typevar_division_simplify;
