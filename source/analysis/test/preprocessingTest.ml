...
let test_populate_nesting_define =
  let assert_populated source_text expected _ =
              ...
              +Statement.Class
                 {
                   ...
                   parent;
                   body =
                     (let parent = ModuleContext.create_class ~parent "C" in
                      [
                        +Statement.Define
                           {
                             signature =
                                  ...
                                  +Statement.Define
                                     {
                                       ...
                                       body =
                                         (let parent =
                                            ModuleContext.create_function ~parent "bar"
                                          in
                                          [
                                            +Statement.Define
                                               {
