...
class A:
    ...
    def self_readonly_str(self: PyreReadOnly[Self]) -> None:
        _test_sink(self.B)

    def self_untyped_str(self) -> None:
        _test_sink(self.B)

    def self_readonly_map(self: PyreReadOnly[Self]) -> None:
        # pyre-ignore[3005]: Ignore ReadOnly Violation
        _test_sink(self.mapping.get(""))

    def self_untyped_map(self) -> None:
        _test_sink(self.mapping.get(""))
