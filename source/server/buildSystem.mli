...
val update : t -> PyrePath.t list -> ArtifactPath.t list Lwt.t
...
val lookup_source : t -> ArtifactPath.t -> PyrePath.t option
...
val lookup_artifact : t -> PyrePath.t -> ArtifactPath.t list
