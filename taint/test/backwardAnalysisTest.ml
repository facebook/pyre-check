  ...
  assert_taint
    ...
    [
      outcome
        ~kind:`Function
        ~sink_parameters:[
          { name = "tainted_parameter1"; sinks = [Sinks.Test]; };
        ]
  ...
  assert_taint
    ...
    [
      outcome
        ~kind:`Function
        ~sink_parameters:[
          { name = "tainted_parameter"; sinks = [Sinks.Test] };
        ]
  ...
  assert_taint
    ...
    [
      outcome
        ~kind:`Method
        ~sink_parameters:[
          { name = "argument"; sinks = [Sinks.Test] };
        ]
        ~tito_parameters:["self"]
        "qualifier.Foo.sink";
    ];
  ...
  assert_taint
    ...
    [
      ...
      outcome
        ~kind:`Function
        ~sink_parameters:[
          { name = "arg1"; sinks = [Sinks.Test] };
          { name = "arg2"; sinks = [Sinks.Test] };
        ]
        "qualifier.sink_in_both";
      outcome
        ~kind:`Function
        ~sink_parameters:[
          { name = "cond"; sinks = [Sinks.Test] };
        ]
